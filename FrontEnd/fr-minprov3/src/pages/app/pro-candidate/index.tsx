...
import { doRequestGetRoac } from '../../redux/MasterSchema/action/actionReducer';
import { doRequestGetCandidate, doRequestUpdateCandidate } from '../../redux/JobhireSchema/action/actionreducer';
    ...
    <div className="bg-white px-7 py-3 rounded-md">
      ...
      {routes ? (
        <Tabs  value={selectRoute}>
          <TabsHeader className="my-5 bg-gray-300">
