...
--
-- Name: batch_trainee_evaluation_modified_date_function(); Type: FUNCTION; Schema: bootcamp; Owner: postgres
--

CREATE FUNCTION bootcamp.batch_trainee_evaluation_modified_date_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
	NEW.btev_modified_date = NOW();
	RETURN NEW;
END;
$$;


ALTER FUNCTION bootcamp.batch_trainee_evaluation_modified_date_function() OWNER TO postgres;
...
--
-- Name: closebatchcoba(json, json); Type: PROCEDURE; Schema: bootcamp; Owner: postgres
--

CREATE PROCEDURE bootcamp.closebatchcoba(IN data json, IN data2 json)
    LANGUAGE plpgsql
    AS $$
declare
	data_store record;
...
ALTER PROCEDURE bootcamp.closebatchcoba(IN data json, IN data2 json) OWNER TO postgres;
...
--
-- Name: createevaluationcoba(integer, json); Type: PROCEDURE; Schema: bootcamp; Owner: postgres
--

CREATE PROCEDURE bootcamp.createevaluationcoba(IN score integer, IN data2 json)
    LANGUAGE plpgsql
    AS $$
declare
...
ALTER PROCEDURE bootcamp.createevaluationcoba(IN score integer, IN data2 json) OWNER TO postgres;

--
-- Name: createprogramapplyprogress(json, json); Type: PROCEDURE; Schema: bootcamp; Owner: postgres
--

CREATE PROCEDURE bootcamp.createprogramapplyprogress(IN data json, IN data2 json)
    LANGUAGE plpgsql
    AS $$
declare
	userEntityId int;
...
ALTER PROCEDURE bootcamp.createprogramapplyprogress(IN data json, IN data2 json) OWNER TO postgres;

--
-- Name: program_apply_modified_date_function(); Type: FUNCTION; Schema: bootcamp; Owner: postgres
--

CREATE FUNCTION bootcamp.program_apply_modified_date_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
	NEW.prap_modified_date = NOW();
	RETURN NEW;
END;
$$;


ALTER FUNCTION bootcamp.program_apply_modified_date_function() OWNER TO postgres;

--
-- Name: program_apply_progress_modified_date_function(); Type: FUNCTION; Schema: bootcamp; Owner: postgres
--

CREATE FUNCTION bootcamp.program_apply_progress_modified_date_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
	NEW.parog_modified_date = NOW();
	RETURN NEW;
END;
$$;


ALTER FUNCTION bootcamp.program_apply_progress_modified_date_function() OWNER TO postgres;

--
-- Name: trainer_programs_modified_date_function(); Type: FUNCTION; Schema: bootcamp; Owner: postgres
--

CREATE FUNCTION bootcamp.trainer_programs_modified_date_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
	NEW.inpro_modified_date = NOW();
	RETURN NEW;
END;
$$;


ALTER FUNCTION bootcamp.trainer_programs_modified_date_function() OWNER TO postgres;

--
-- Name: update_batch(integer, integer, character varying, character varying, date, date, character varying, character varying, integer, json, json, json); Type: PROCEDURE; Schema: bootcamp; Owner: postgres
--

CREATE PROCEDURE bootcamp.update_batch(IN b_id integer, IN entity_id integer, IN b_name character varying, IN description character varying, IN start_date date, IN end_date date, IN reason character varying, IN b_type character varying, IN pic_id integer, IN addedtrainee json, IN deletedtrainee json, IN trainer json)
    LANGUAGE plpgsql
    AS $$
DECLARE
BEGIN
...
INSERT INTO bootcamp.batch_trainee (batr_status, batr_access_token, 
									batr_access_grant, batr_batch_id, batr_trainee_entity_id
								   )
select x.batr_status, x.batr_access_token, x.batr_access_grant,B_id, batr_trainee_entity_id
from json_to_recordset(addedTrainee)x (batr_status varchar(15), batr_access_token varchar(255), batr_access_grant char(1), batr_trainee_entity_id integer);


-----------------hapus trainee yang ga selected-----------------
DELETE FROM bootcamp.batch_trainee
WHERE batr_batch_id = B_id
  AND batr_trainee_entity_id IN (SELECT x.batr_trainee_entity_id FROM json_to_recordset(deletedTrainee) x (batr_trainee_entity_id integer));



-------------------hapus trainernya based on batch id--------------
DELETE FROM bootcamp.trainer_programs where batch_id = B_id ;


--------------------add trainernya-----------------
INSERT INTO bootcamp.trainer_programs (batch_id, tpro_entity_id, tpro_emp_entity_id)
	select 
		B_id,
		z.tpro_entity_id,
		z.tpro_emp_entity_id
...
ALTER PROCEDURE bootcamp.update_batch(IN b_id integer, IN entity_id integer, IN b_name character varying, IN description character varying, IN start_date date, IN end_date date, IN reason character varying, IN b_type character varying, IN pic_id integer, IN addedtrainee json, IN deletedtrainee json, IN trainer json) OWNER TO postgres;
...
CREATE TABLE bootcamp.batch_trainee (
    ...
    batr_total_score numeric DEFAULT 0,
    ...
    CONSTRAINT check_batr_status CHECK (((batr_status)::text = ANY ((ARRAY['passed'::character varying, 'failed'::character varying, 'resign'::character varying, 'running'::character varying, 'selected'::character varying])::text[])))
);
...
CREATE TABLE bootcamp.program_apply (
    ...
    CONSTRAINT check_prap_status CHECK (((prap_status)::text = ANY ((ARRAY['recommendation'::character varying, 'passed'::character varying, 'wait'::character varying, 'failed'::character varying])::text[])))
);
...
CREATE TABLE bootcamp.talents (
    ...
    talent_status character varying(15) DEFAULT 'idle'::character varying
);
...
ALTER SEQUENCE bootcamp.talent_id_seq OWNED BY bootcamp.talents.id;
...
CREATE TABLE bootcamp.trainer_programs (
    batch_id integer NOT NULL,
    tpro_entity_id integer NOT NULL,
    tpro_emp_entity_id integer NOT NULL,
    tpro_modified_date timestamp with time zone DEFAULT now()
);
...
--
-- Name: talents id; Type: DEFAULT; Schema: bootcamp; Owner: postgres
--

ALTER TABLE ONLY bootcamp.talents ALTER COLUMN id SET DEFAULT nextval('bootcamp.talent_id_seq'::regclass);
...
4	1	BATCH#15	ini description1	2023-06-08	2023-09-07	open	update aja	offline	2023-06-09 23:31:20.816647+07	1
\.
...
10	selected	\N	\N	access_token	0	\N	0	2023-06-09 23:29:05.418002+07	2	4
11	selected	\N	\N	access_token	0	\N	0	2023-06-09 23:31:20.816647+07	3	4
12	selected	\N	\N	access_token	0	\N	0	2023-06-09 23:31:20.816647+07	4	4
\.
...
1	1	\N	3.69	\N	\N	2023-06-09 23:16:13.640949+07	wait
2	1	\N	3.69	\N	\N	2023-06-09 23:16:13.640949+07	wait
\.
...
1	1	1	2023-06-06 19:30:00+07	2023-06-09 23:16:13.640949+07	\N	apply	1	open
\.
...
COPY bootcamp.talents (id, talent_fullname, talent_user_entity_id, talent_technology, talent_batch_id, talent_start_date, talent_end_date, talent_trainer, talent_skill, talent_status) FROM stdin;
\.
...
4	1	3	2023-06-09 23:31:20.816647+07
4	1	4	2023-06-09 23:31:20.816647+07
\.
...
1	\N	\N	\N	\N	\N	\N	2023-06-09 23:12:07.945777+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
2	\N	\N	\N	\N	\N	\N	2023-06-09 23:12:22.663232+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
3	\N	\N	\N	\N	\N	\N	2023-06-09 23:12:26.059333+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
4	\N	\N	\N	\N	\N	\N	2023-06-09 23:12:29.50054+07	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N
\.
...
open	2023-06-09 23:20:00.475241+07
running	2023-06-09 23:21:00.067646+07
pending	2023-06-09 23:21:09.333853+07
cancelled	2023-06-09 23:21:19.339773+07
extend	2023-06-09 23:21:30.047318+07
wait	2023-06-09 23:43:18.090246+07
recommendation	2023-06-09 23:48:08.537402+07
passed	2023-06-09 23:48:49.232959+07
failed	2023-06-09 23:48:59.478686+07
\.
...
1	\N	\N	\N	\N	\N	0	\N	\N	\N	\N
2	\N	\N	\N	\N	\N	0	\N	\N	\N	\N
3	\N	\N	\N	\N	\N	0	\N	\N	\N	\N
4	\N	\N	\N	\N	\N	0	\N	\N	\N	\N
\.
...
SELECT pg_catalog.setval('bootcamp.batch_batch_id_seq', 4, true);
...
SELECT pg_catalog.setval('bootcamp.batch_trainee_batr_id_seq', 12, true);
...
SELECT pg_catalog.setval('bootcamp.program_apply_progress_parog_id_seq', 1, true);
...
--
-- Name: trainer_programs instructor_programs_emp_entity_id_pkey; Type: CONSTRAINT; Schema: bootcamp; Owner: postgres
--

ALTER TABLE ONLY bootcamp.trainer_programs
    ADD CONSTRAINT instructor_programs_emp_entity_id_pkey PRIMARY KEY (batch_id, tpro_emp_entity_id);
...
--
-- Name: talents talent_pkey; Type: CONSTRAINT; Schema: bootcamp; Owner: postgres
--
...
--
-- Name: batch_trainee_evaluation batch_trainee_evaluation_modified_date_trigger; Type: TRIGGER; Schema: bootcamp; Owner: postgres
--

CREATE TRIGGER batch_trainee_evaluation_modified_date_trigger BEFORE UPDATE ON bootcamp.batch_trainee_evaluation FOR EACH ROW EXECUTE FUNCTION bootcamp.batch_trainee_evaluation_modified_date_function();
...
--
-- Name: program_apply program_apply_modified_date_trigger; Type: TRIGGER; Schema: bootcamp; Owner: postgres
--

CREATE TRIGGER program_apply_modified_date_trigger BEFORE UPDATE ON bootcamp.program_apply FOR EACH ROW EXECUTE FUNCTION bootcamp.program_apply_modified_date_function();


--
-- Name: program_apply_progress program_apply_progress_modified_date_trigger; Type: TRIGGER; Schema: bootcamp; Owner: postgres
--

CREATE TRIGGER program_apply_progress_modified_date_trigger BEFORE UPDATE ON bootcamp.program_apply_progress FOR EACH ROW EXECUTE FUNCTION bootcamp.program_apply_progress_modified_date_function();


--
-- Name: trainer_programs trainer_programs_modified_date_trigger; Type: TRIGGER; Schema: bootcamp; Owner: postgres
--

CREATE TRIGGER trainer_programs_modified_date_trigger BEFORE UPDATE ON bootcamp.trainer_programs FOR EACH ROW EXECUTE FUNCTION bootcamp.trainer_programs_modified_date_function();
...
ALTER TABLE ONLY bootcamp.trainer_programs
    ADD CONSTRAINT instructor_programs_inpro_emp_entity_id_fkey FOREIGN KEY (tpro_emp_entity_id) REFERENCES hr.employee(emp_entity_id);


--
-- Name: program_apply_progress program_apply_parog_status_fkey; Type: FK CONSTRAINT; Schema: bootcamp; Owner: postgres
--

ALTER TABLE ONLY bootcamp.program_apply_progress
    ADD CONSTRAINT program_apply_parog_status_fkey FOREIGN KEY (parog_status) REFERENCES master.status(status);
...
--
-- Name: talents talent_talent_batch_id_fkey; Type: FK CONSTRAINT; Schema: bootcamp; Owner: postgres
--
...
--
-- Name: talents talent_talent_user_entity_id_fkey; Type: FK CONSTRAINT; Schema: bootcamp; Owner: postgres
--
...
--
-- Name: talents talent_teknologi_fkey; Type: FK CONSTRAINT; Schema: bootcamp; Owner: postgres
--

ALTER TABLE ONLY bootcamp.talents
    ADD CONSTRAINT talent_teknologi_fkey FOREIGN KEY (talent_technology) REFERENCES curriculum.program_entity(prog_entity_id);
